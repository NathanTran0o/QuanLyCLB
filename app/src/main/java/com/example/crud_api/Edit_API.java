...
public class Edit_API extends AppCompatActivity {
    private EditText edt_name, edt_student_code, edt_grade, edt_major,edt_date,edt_role;
    private CircleImageView mPicture;
    private FloatingActionButton mFabChoosePic;
    Calendar myCalendar = Calendar.getInstance();
    private Bitmap bitmap;
    private String name, student_code, grade, major, birth,picture,role;
    private int id;
    private Menu action;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_role = findViewById(R.id.ed_std_role);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                dialog.setMessage("Bạn có chắc chắn xóa ?");
    ...
    private void postData(final String key) {
        ...
        Call<Student> call = apiInterface.insertStudent( key, name, student_code, grade,major, birth, image,role);
...
// Gọi Hàm Call Back đẩy dữ liệu lên host thông qua API interface
        Call<Student> call = apiInterface.update_student( key,id, name, student_code, grade,major, birth, image,role);
        call.enqueue(new Callback<Student>() {
            @Override
            public void onResponse(Call<Student> call, Response<Student> response) {
                progressDialog.dismiss();
